...
class LoadBalancerFactoryTest {
  ...
  @Test
  void createRandom() {
    LoadBalancer lb = LoadBalancerFactory.create(LoadBalanceType.RANDOM);
    assertInstanceOf(RandomLoadBalancer.class, lb);
  }

  @Test
  void createRoundRobin() {
    LoadBalancer lb = LoadBalancerFactory.create(LoadBalanceType.ROUND_ROBIN);
    assertInstanceOf(RoundRobinLoadBalancer.class, lb);
  }

  @Test
  void createWeighted() {
    LoadBalancer lb = LoadBalancerFactory.create(LoadBalanceType.WEIGHTED);
