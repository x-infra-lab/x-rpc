...
public class ServiceController {
  ...
  public ServiceController(ConsoleRegistryService registryService) {
  ...
  @GetMapping("/{appName}/providers")
  public List<InstanceVO> getServiceProviders(@PathVariable String appName) throws Exception {
    return registryService.getServiceProviders(appName);
  }
}
