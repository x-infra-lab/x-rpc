...
public class ConsumerInvoker implements Invoker {
  ...
  public ConsumerInvoker(ClientTransportManager clientTransportManager) {
  ...
  public InvocationResult invoke(Invocation invocation) {
    ...
    ClientTransport clientTransport =
        clientTransportManager.getClientTransport(targetServiceInstance);

    // todo
    RpcRequest request = new RpcRequest();
    CompletableFuture<RpcResponse> future = clientTransport.sendAsync(request);
    // todo
